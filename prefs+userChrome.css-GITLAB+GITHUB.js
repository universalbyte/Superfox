// Version: 1.Y2020M12D28

// IMPORTANT INFO: Please DON'T file a bug report to MOZILLA if anything doesn't work ! Instead search in this file for a solution or contact the maintainer/developer of this prefs.js file. Thank you.

// Copy this file in your BACKUP Location !

// INFO: This is a prefs.js + userChrome.css file ! Remove lines from "START: userChrome.css file !" to "END: userChrome.css file !" if you don't want to use a userChrome.css file !

// INFO: Please read ALL "//" lines to get the best Information about this "prefs.js" file ! Download a portable version of Firefox from the sources below, so that your default Firefox doesn't brake !

// WindowsOS: https://portableapps.com
// GNU/LinuxOS: https://www.mozilla.org

// INFO: Create a "profile" folder in your "FirefoxPortable" Directory and copy this "prefs.js" file in your "/FirefoxPortable/profile/" folder and search in the file for // , edit these entries and activate them by removing these 2 slashes at the beginning of the entry/pref.
...
user_pref("browser.cache.disk.capacity", 1024000); // INFO: 1024000=1Gigabyte
//user_pref("browser.cache.disk.enable", true); // INFO: Remove the 2 // only when you are using a "RAM-Disk" with "browser.cache.disk.parent_directory" !
//user_pref("browser.cache.disk.parent_directory", "WindowsOS: RAM-Disk-Letter:\FirefoxPortableCache\ , GNU/LinuxOS: /Path/to/RAM-Disk/FirefoxPortableCache/"); "browser.cache.disk.enable" MUST be set to TRUE to use this entry ! WindowsOS Software INFO: https://en.wikipedia.org/wiki/RAM_drive GNU/LinuxOS INFO: make /tmp/ into a TMPFS or use /dev/shm/FirefoxPortableCache/ ! /etc/fstab: tmpfs /tmp/ tmpfs rw,nodev,nosuid,nodiratime,noatime,size=(Fill in at least 512 to 1024 Megabytes, or more if you have more RAM, and remove the Brackets)M 0 0
...
// INFO: Remove all "browser.safebrowsing." preferences to enable "Safe Browsing".
...
//user_pref("browser.startup.homepage", "https://duckduckgo.com https://startpage.com https://searx.info https://www.qwant.com https://www.google.com=NOT recommended!"); // Choose 1 of these "Privacy Search Engines" (excluded GOOGLE) to set it for the HOME icon next to the URL-Bar ! DuckDuckGo = Yahoo , Bing , Yandex Results ; Startpage = Google Results ; Searx = Bing Results ; Qwant = Bing Results , Google , Reddit , Wikipedia , Yahoo , Yandex Results
...
// INFO: Remove all "identity.fxaccounts." preferences to enable the "Firefox Account".
...
//user_pref("network.http.referer.spoofSource", true); // Some Captchas may not work !
...
user_pref("network.trr.mode", 2); // 0:DOH=disabled , 2:DOH=enabled ISP/DNS=Backup , 3:DOH=enabled ISP/DNS=disabled. "3" doesn't let Firefox connect to the Internet ! BUG ! // This Preference WILL ignore your "hosts" file ! INFO: https://en.wikipedia.org/wiki/Hosts_(file)
...
// INFO: Remove all "services.sync." preferences to enable synchronization with your "Firefox Account".
...
//user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true); // Remove the 2 / in front of "user_pref" to use a "/FirefoxPortable/profile/chrome/userChrome.css" file. INFO: https://www.userchrome.org or search on the internet for "firefox userchrome.css". File below !
...
// END: prefs.js file !
//
// IMPORTANT INFO: Remove all lines below from this prefs.js file so that Firefox doesn't act weird !
//
// START: userChrome.css file !
// INFO: /FirefoxPortable/profile/chrome/userchrome.css <- Remove this line !
// user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true); <- Remove this line !
